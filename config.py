...
# Юзернейм бота
BOT_USERNAME = os.environ.get('BOT_USERNAME', 'CriptoMeter_bot')

# Канал для уведомлений
CHANNEL_USERNAME = os.environ.get('CHANNEL_USERNAME', '@bountycoinCL')

# Настройки майнинга
MINING_COOLDOWN = 300  # 1 час в секундах
...
START_BALANCE = 2000  # Стартовый баланс в тонах

# Настройки рефералов
REFERRAL_BONUS = 1200  # Бонус пригласившему в тонах
REFERRAL_EXP_BONUS = 600  # Бонус пригласившему в опыте
REFERRAL_BONUS_FOR_NEW = 600  # Бонус новому пользователю в тонах
REFERRAL_EXP_FOR_NEW = 300  # Бонус новому пользователю в опыте
...
AUTO_RESTOCK_TIME = "9:00"  # Время пополнения (МСК)
